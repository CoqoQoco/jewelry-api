...
public partial class StockFromConvert
{
    public int Recgen { get; set; }
    ...
    public string? Typesil { get; set; }

    public string? Wsil { get; set; }

    public string? Unitsil { get; set; }
    ...
    public int? Qtyd1 { get; set; }

    public int? Wd1 { get; set; }

    public string? Unitd1 { get; set; }

    public int? Priced1 { get; set; }

    public string? OriginD1 { get; set; }
}
