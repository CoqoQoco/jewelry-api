...
#PostgreSQL
dotnet ef dbcontext scaffold 'Server=localhost;Port=5432;Database=prod_20250721;User Id=postgres;Password=winsun24;Trust Server Certificate=true;' Npgsql.EntityFrameworkCore.PostgreSQL -o Models/Jewelry --context-dir Context/ --context JewelryContext -f --no-pluralize --no-onconfiguring 
